  ...
  return (
    <div className='relative pb-20'>
        ...
        <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-32'>
            <motion.h2 initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.3}} viewport={{once:true}} className='text-2xl sm:text-3xl lg:text-4xl text-white text-center mb-16 font-semibold'>Join our Discord community</motion.h2>
            <div>
